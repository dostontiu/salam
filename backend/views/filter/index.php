...
/* @var $searchModel common\models\search\FilterQuery */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Филтери');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="filter-index col-md-6 col-md-offset-3">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    ...
                    <div class="dropdown dropdown-inline">
                        <a href="<?=Yii::$app->homeUrl?>filter/create" class="btn btn-brand btn-icon-sm">
